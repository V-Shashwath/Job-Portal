  ...
  return (
    <div className='text-center'>
        <div className='flex flex-col gap-5 my-10'>
            ...
            <p className=''>"Unlock your career potential by connecting with top employers and endless opportunities for growth and success"</p>
            <div className='flex w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto '>
                ...
                />
                <Button onClick={searchJobHandler} className='rounded-r-full bg-purple-500'>
